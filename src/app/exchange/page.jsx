    ...
    <div className="h-screen w-full relative left-0 flex flex-col items-center">
      ...
      <div className="w-full h-screen flex items-center font-space_grotesk bg-white ">
        ...
        <div className={` w-full h-full`}>
          {/* Wrapper */}
          <div className="w-full h-full">
            <div className="pl-4 h-full md:h-[80%] overflow-y-scroll hideScrollBar">
              <p className="text-xl font-bold mt-5">Exchange</p>

              <div className="w-full">
                <ExchangePanel userEmail={session?.user?.email} />
              </div>
            </div>
          </div>
        </div>
